"""
Django settings for north_team project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure--fgg5&nq-14(5k!sbc!6-m-e^8z&p4i_-hd7r#!(+o7-l3*ksv')
...
WSGI_APPLICATION = 'north_team.wsgi.application'
